...
export const demo: z.infer<typeof internshipSchema> = {
  ...
  tech: {
    ...
    deliverables: ["Live API", "GitHub Repository", "Postman Collection"],
    milestones: [
  ...
  management: {
    ...
    deliverables: ["Product PRD", "Market Report", "Launch Strategy"],
    milestones: [
      "Week 1: User Research",
      "Week 4: PRD",
      "Week 6: Pricing Model",
      "Week 8: Launch Plan"
    ],
    start_date: new Date("2026-02-01"),
    end_date: new Date("2026-03-31"),
                ...
                <div>
                  ...
                  <Card>
                    <CardContent className="flex items-center gap-2">
                      <Avatar>
                        <AvatarImage src={selectedCoHost.avatar} />
                        <AvatarFallback>CN</AvatarFallback>
                      </Avatar>
                      <div>
                        <h1 className=" text-sm font-semibold">

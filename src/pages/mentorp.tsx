    ...
    <div className="min-h-screen container py-12 md:px-4 md:py-10 mx-auto">
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {/* Expertise Area */}
          <Card className="bg-card/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 border-border/50 p-6 ion-300">
          ...
          {/* Years of Experience */}
          <Card className="bg-card/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 border-border/50 p-6">
            <div className="flex items-center gap-3 mb-4">
          ...
          <Card className="bg-card/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 border-border/50 p-6 md:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
          ...
          <Card className="bg-card/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 border-border/50 p-6 md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 rounded-lg bg-chart-2/10">

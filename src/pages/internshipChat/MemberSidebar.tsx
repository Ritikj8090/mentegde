    ...
    <AnimatePresence>
      {showMembers && (
        <motion.div
          ...
          className="border-l border-zinc-800 bg-zinc-900/30 overflow-hidden"
        >
                ...
                <div className="space-y-1">
                  {filteredMembers
                    ...
                    .map((user) => (
                      <div
                        key={user.id}
                        className="flex items-center gap-2 p-2 rounded-lg hover:bg-zinc-800/50 transition-colors cursor-pointer"
                      >
